...
function determineSource(cpData: any, sourceData: any, subSourceData: any): string {
  ...
  // 2. Check Lead Source keywords
  if (rawSource.length > 0) {
    const match = checkKeywords(rawSource);
    if (match) return match;
  }

  // 3. Check Sub Source keywords
  if (rawSubSource.length > 0) {
    const match = checkKeywords(rawSubSource);
    if (match) return match;
  }
  
  // 4. Fallback: Return Lead Source if present
  if (rawSource.length > 0) return rawSource;
  
  return '-';
}

// --- Image Generation: Daily List ---

async function generateDailyListImage(siteName: string, rows: any[], dateLabel: string, startDate: string, endDate: string): Promise<string> {
  ...
  const headerHtml = `
    <th style="padding: 6px 4px; text-align: center; border: 1px solid #000000; font-size: 11px; font-weight: 900; font-family: 'Arial', sans-serif; color: #000000; background-color: #f3f4f6; width: 40px;">Sr. No.</th>
    <th style="padding: 6px 4px; text-align: left; border: 1px solid #000000; font-size: 11px; font-weight: 900; font-family: 'Arial', sans-serif; color: #000000; background-color: #f3f4f6;">Visitor Name</th>
    <th style="padding: 6px 4px; text-align: center; border: 1px solid #000000; font-size: 11px; font-weight: 900; font-family: 'Arial', sans-serif; color: #000000; background-color: #f3f4f6; width: 80px;">Team</th>
    <th style="padding: 6px 4px; text-align: center; border: 1px solid #000000; font-size: 11px; font-weight: 900; font-family: 'Arial', sans-serif; color: #000000; background-color: #f3f4f6; width: 100px;">Source</th>
    <th style="padding: 6px 4px; text-align: center; border: 1px solid #000000; font-size: 11px; font-weight: 900; font-family: 'Arial', sans-serif; color: #000000; background-color: #f3f4f6; width: 140px;">CP Firm Name</th>
    <th style="padding: 6px 4px; text-align: center; border: 1px solid #000000; font-size: 11px; font-weight: 900; font-family: 'Arial', sans-serif; color: #000000; background-color: #f3f4f6; width: 85px;">Visit Date</th>
    <th style="padding: 6px 4px; text-align: center; border: 1px solid #000000; font-size: 11px; font-weight: 900; font-family: 'Arial', sans-serif; color: #000000; background-color: #f3f4f6; width: 85px;">2nd Visit</th>
    <th style="padding: 6px 4px; text-align: center; border: 1px solid #000000; font-size: 11px; font-weight: 900; font-family: 'Arial', sans-serif; color: #000000; background-color: #f3f4f6; width: 85px;">3rd Visit</th>
    <th style="padding: 6px 4px; text-align: center; border: 1px solid #000000; font-size: 11px; font-weight: 900; font-family: 'Arial', sans-serif; color: #000000; background-color: #f3f4f6; width: 85px;">4th Visit</th>
    <th style="padding: 6px 4px; text-align: center; border: 1px solid #000000; font-size: 11px; font-weight: 900; font-family: 'Arial', sans-serif; color: #000000; background-color: #f3f4f6; width: 85px;">5th Visit</th>
    <th style="padding: 6px 4px; text-align: center; border: 1px solid #000000; font-size: 11px; font-weight: 900; font-family: 'Arial', sans-serif; color: #000000; background-color: #f3f4f6; width: 110px;">State</th>
  `;
  ...
  container.innerHTML = `
    <div style="background-color: #ffffff; width: 100%; border: 1px solid #000000; box-sizing: border-box; font-family: 'Calibri', sans-serif;">
      <div style="padding: 12px 15px; background-color: #ffffff; text-align: center;">
        <div style="font-size: 14px; font-weight: 900; font-family: 'Arial', sans-serif; color: #000000; text-transform: uppercase;">SITE VISIT</div>
        ...
        <div style="width: 150px; height: 1px; background-color: #000000; margin: 6px auto;"></div>
        <div style="font-size: 12px; font-weight: 700; font-family: 'Arial', sans-serif; color: #000000;">${dateLabel}</div>
      </div>

      <div style="padding: 5px 2px; display: flex; justify-content: space-between; font-size: 11px; font-weight: 700; font-family: 'Arial', sans-serif; color: #000000;">
...
export async function processDailySiteVisitFile(file: File, manualStartDate?: string, manualEndDate?: string, sourceFilter: string = 'All'): Promise<ProcessResponse> {
  return new Promise((resolve, reject) => {
    ...
    reader.onload = async (e) => {
      try {
        ...
        if (siteKeys.length === 0) throw new Error("No matching records found. Either no data matched the project mapping, or no visits fell within the selected date range.");

        // Format Manual Dates for Header
        ...
        for (const site of siteKeys) {
          ...
          // Header Label
          const dateLabel = "DAILY REPORT";

          // 1. Generate Daily List Image
          const listDataUrl = await generateDailyListImage(site, rows, dateLabel, finalStartDateStr, finalEndDateStr);
          ...
          const summaryDataUrl = await generateDailySummaryImage(site, rows, summaryStats, sourceStats, dateLabel, finalStartDateStr, finalEndDateStr);
